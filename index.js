export function decomposeUrl(urlStr, allowDuplicateParamKeys = true) {
...
export function composeUrl(urlInfo, ...allowedKeys) {
...
async function main() {
  ...
  let _generate = ui.create("button").style({
    flex: "1",
    margin: "0.5em",
    borderRadius: "0.5em",
